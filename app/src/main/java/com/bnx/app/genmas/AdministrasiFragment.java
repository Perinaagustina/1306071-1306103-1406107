 ...
 */
public class AdministrasiFragment extends Fragment {

    TextView text;

    public AdministrasiFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View view = inflater.inflate(R.layout.fragment_administrasi, container, false);

        text = (TextView) view.findViewById(R.id.content_uraian);
        new doTaskStart().execute("data/adm.txt");
